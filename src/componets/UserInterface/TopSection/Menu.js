...
const Menu = (props) => {
    ...
    const showNewProductModalHandler = () => {
    ...
    const hiddenNewProductModalHandler = useCallback(() => {
    ...
    return (
        <React.Fragment>
            ...
            {newProductModalActive && (
                <Modal onHidden={hiddenNewProductModalHandler}>
                    <NewProduct onHidden={hiddenNewProductModalHandler}></NewProduct>
                </Modal>
            )}
            <nav className={styles["top-menu"]}>
                <ul className={styles["top-menu-list"]}>
                    ...
                    <li className={styles["top-menu-item"]}>
                        <a href="#" onClick={showOrderModalHandler}>Your Order <span
                            className={styles["user-order-count"]}>{orderItemsCount}</span></a>
                    </li>
                    {authCtx.isLoggedIn && (
                        <li className={styles["top-menu-item"]}>
                            <a href="#">Collection</a>
                    ...
                    <li className={styles["top-menu-item"]}>
                        <a href="#" onClick={showNewProductModalHandler}>Add Product</a>
                    </li>
                    {authCtx.isLoggedIn ? (
                        <li className={styles["top-menu-item"]}>
                            <a href="#">Logout</a>
